...
```{r}
#write_csv(PhoneRecruitment, "~/UTHealth Houston/Cannell, Michael B - Outbound call logs/data for import to FM Pro/PhoneRecruitment/Phone_correct_1833_DETECT_CallHistory_20220307.CSV", na = "")

#write_csv(CallLog, "~/UTHealth Houston/Cannell, Michael B - Outbound call logs/data for import to FM Pro/CallLog/Call_correct_1833_DETECT_CallHistory_20220307.CSV", na = "")

#write_csv(ParticipantScheduler, "~/UTHealth Houston/Cannell, Michael B - Outbound call logs/data for import to FM Pro/ParticipantScheduler/Par_correct_1833_DETECT_CallHistory_20220307.CSV", na = "")
```
